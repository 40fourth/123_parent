...
// smoothscroll
// discuss what this is and why it is here
// create some 'classes'
var Theme = {}; // tbd
...
(0, _jquery["default"])(document).ready(function () {
  ...
  */
  ...
  Theme.FadeEffects = {
    elements: (0, _jquery["default"])('.site__fade'),
    _init: function _init() {
      (0, _jquery["default"])(window).on('scroll load', Theme.FadeEffects._scrollLoadHandler);
    },
    _scrollLoadHandler: function _scrollLoadHandler(e) {
      for (var index = 0; index < Theme.FadeEffects.elements.length; index++) {
        var element = Theme.FadeEffects.elements[index];

        if ((0, _jquery["default"])(window).scrollTop() + (0, _jquery["default"])(window).height() > (0, _jquery["default"])(element).offset().top + 50) {
          (0, _jquery["default"])(element).removeClass('site__fade-up site__fade-in site__fade-left site__fade-right');
        }
      }
    }
  };
  ...
  if ((0, _jquery["default"])('#popups__banner').length && (0, _jquery["default"])('#popups__banner_overlay').length) {
    ...
    PopUps.Banner = {
      ...
      _init: function _init() {
        ...
        (0, _jquery["default"])('.overlay__closebutton').on('click', PopUps.Banner._closePopUp);
      },
      ...
      _clickedOverlayBG: function _clickedOverlayBG(e) {
  ...
  if ((0, _jquery["default"])('#popups__header_overlay').length) {
    PopUps.Header = {
      overlay: (0, _jquery["default"])('#popups__header_overlay'),
      _init: function _init() {
        (0, _jquery["default"])('.site__button-quote').on('click', PopUps.Header._openPopUp);
        PopUps.Header.overlay.on('click', PopUps.Header._clickedOverlayBG);
        (0, _jquery["default"])('.overlay__closebutton').on('click', PopUps.Header._closePopUp);
      },
      _openPopUp: function _openPopUp(e) {
        (0, _jquery["default"])('body').addClass('js__noscroll');
  ...
  if ((0, _jquery["default"])('#popups__timed_overlay').length) {
    PopUps.Timed = {
      overlay: (0, _jquery["default"])('#popups__timed_overlay'),
      _init: function _init() {
        ...
        (0, _jquery["default"])('.overlay__closebutton').on('click', PopUps.Timed._closePopUp);
      },
      _closePopUp: function _closePopUp() {
        (0, _jquery["default"])('body').removeClass('js__noscroll');
  ...
  if ((0, _jquery["default"])('section.block__galleries').length && (0, _jquery["default"])('section.block__galleries div.tabs').length || (0, _jquery["default"])('section.tpl_page_gallery').length && (0, _jquery["default"])('section.tpl_page_gallery div.tabs').length) {
    (0, _jquery["default"])('.galleries ul li .image').magnificPopup({
      'type': 'image'
    });
    Blocks.Gallery = {
      ...
      _didClickTab: function _didClickTab(e) {
        ...
        (0, _jquery["default"])(this).parent('li').addClass('tab_active');
      }
    };
  ...
  */
  ...
  if ((0, _jquery["default"])('section.block__food_menus').length && (0, _jquery["default"])('section.block__food_menus div.tabs').length || (0, _jquery["default"])('section.tpl_page_menu').length && (0, _jquery["default"])('section.tpl_page_menu div.tabs').length) {
    Blocks.FoodMenus = {
      tabs: (0, _jquery["default"])('.block__food_menus div.tabs > ul > li, .tpl_page_menu div.tabs > ul > li'),
      food_menus: (0, _jquery["default"])('.block__food_menus div.tabs > .menu_area > ul.menu_section, .tpl_page_menu div.tabs > .menu_area > ul.menu_section'),
      _init: function _init() {
      ...
      _didClickTab: function _didClickTab(e) {
        ...
        (0, _jquery["default"])(Blocks.FoodMenus.food_menus[(0, _jquery["default"])(this).parent('li').index()]).addClass('current_food_menu');
...
Headers.Eight = {
  ...
  _sticky_header: function _sticky_header() {
...
Headers.Site_Bars = {
  site_bars: (0, _jquery["default"])(".site__bars"),
  sidebar: (0, _jquery["default"])(".sidebar_menu"),
  outside: (0, _jquery["default"])("body, html"),
  _init: function _init() {
    ...
    Headers.Site_Bars.sidebar.on("blur", Headers.Site_Bars._close_sidebar); //On browser resize

    window.addEventListener('resize', function () {
      Headers.Site_Bars._close_sidebar();
    });
  },
  _site_bars_click: function _site_bars_click(e) {
    e.stopPropagation(); //If header 10 hamburger icon link has class of ...
  ...
  _close_sidebar: function _close_sidebar() {
    //Add hamburger icon link class
    Headers.Site_Bars.site_bars.removeClass("site_bars_changed"); //Open sidebar navigational menu

    Headers.Site_Bars.sidebar.removeClass("header_sidebar_cover_all");
  },
  _open_sidebar: function _open_sidebar() {
    //Remove hamburger icon link class
    Headers.Site_Bars.site_bars.addClass("site_bars_changed"); //Close sidebar navigational menu
...
Headers.Sidebar = {
  ...
  sidebar: (0, _jquery["default"])(".mobile_header_sidebar"),
  //Mobile header sidebar and mobile header first div element
  outside: (0, _jquery["default"])("body, html"),
  //Link which is the parent of the hamburger icons (spans)
  toggle: (0, _jquery["default"])("header.mobileheader > div:first-of-type > a"),
  _init: function _init() {
    ...
    Headers.Sidebar.sidebar.on("blur", Headers.Sidebar._close_sidebar); //On resize of browser

    window.addEventListener('resize', function () {
      //Remove mobile nav sidebar menu width
      Headers.Sidebar.sidebar.removeClass("mobile_sidebar_cover_all"); //Remove mobile nav hamburger icon class

      Headers.Sidebar.toggle.removeClass("mobile_nav_sidebar");
    });
  },
  _clickHandler: function _clickHandler(e) {
    e.stopPropagation(); //If the hamburger icon spans link does not have class of mobile_nav_sidebar_menu_1
  ...
  _open_sidebar: function _open_sidebar() {
    ...
    Headers.Sidebar.toggle.addClass("mobile_nav_sidebar"); //Make the sidebar menu cover the whole page

    Headers.Sidebar.sidebar.addClass("mobile_sidebar_cover_all");
  },
  _close_sidebar: function _close_sidebar() {
    //Hamburger icon link remove class
    Headers.Sidebar.toggle.removeClass("mobile_nav_sidebar"); //Make the sidebar menu to not cover the whole page
...
Headers.One = {
  ...
  div_two: (0, _jquery["default"])("header.header#opt_header_one>div:last-of-type"),
  _init: function _init() {
    if ((0, _jquery["default"])(Headers.One.header).length) {
      Headers.One.div_two_offset_top = (0, _jquery["default"])("header#opt_header_one > div:nth-of-type(2)").offset().top;
...
Theme.CookieMonster = {
  ...
  _listenCookieExpire: function _listenCookieExpire(cookieName, callback) {
  ...
  _setCookie: function _setCookie(cname, cvalue, ctime, days) {
    var d = new Date(); // if days is set to false use seconds
  ...
  _getCookieValue: function _getCookieValue(cname) {
    var nameEQ = cname + "=";
  ...
  _cookieExists: function _cookieExists(cname) {
  ...
  _deleteCookie: function _deleteCookie(name) {
    document.cookie = name + '=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';
  },
  _firstTimeExpire: function _firstTimeExpire() {
    Theme.PA._showPA();
  }
};
Theme.Parallax = {
  strength: 25,
  stronger: 175,
  imagesections: (0, _jquery["default"])('.parallax-image'),
  _init: function _init() {
    (0, _jquery["default"])(window).on('resize scroll load', Theme.Parallax._resizeLoadScrollHandler);
  },
  _map: function _map(n, i, o, r, t) {
    return i > o ? i > n ? (n - i) * (t - r) / (o - i) + r : r : o > i ? o > n ? (n - i) * (t - r) / (o - i) + r : t : void 0;
  },
  _getAmount: function _getAmount(el, strength) {
    var windowcenter = (0, _jquery["default"])(window).scrollTop() + (0, _jquery["default"])(window).height() / 2;
    var sectioncenter = (0, _jquery["default"])(el).offset().top + (0, _jquery["default"])(el).height() / 2;
    var sectiondelta = windowcenter - sectioncenter;

    var scale = Theme.Parallax._map(sectiondelta, 0, (0, _jquery["default"])(window).height(), 0, strength);
...
},{"jquery":2,"magnific-popup":3,"slick-carousel-browserify":5,"timers":6,"zenscroll":7}],2:[function(require,module,exports){
/*!
